"""organization plugin: core org/member management, invitations, teams, and dynamic
access control.
...
Invitations are implemented: the ``invitation`` table, invite/accept/reject/
...
Teams are implemented (gated on ``teams={"enabled": True}``): the ``team`` /

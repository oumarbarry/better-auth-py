...
| `domain` | `str` | required | Hosted-UI domain; a leading `https://` is stripped. Missing raises `ValueError` at construction. |
| `region` | `str` | required | AWS region of the pool. Missing raises `ValueError` at construction. |

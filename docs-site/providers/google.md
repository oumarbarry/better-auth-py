...
- OIDC: a nonce is generated, sent on the authorize URL and checked at verification. Id tokens are verified against `https://www.googleapis.com/oauth2/v3/certs` with issuers `https://accounts.google.com` and `accounts.google.com`. This supports direct id-token sign-in.

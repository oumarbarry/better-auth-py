"""Wire-compat tests against the better-auth TS wire shape: /verify-password,
/list-accounts, /revoke-session (see test_sessions.py), /update-user, and
/change-password's revokeOtherSessions (see test_email_password.py)."""

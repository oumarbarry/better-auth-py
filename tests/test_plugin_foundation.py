"""Core-plumbing unit tests not covered by a more specific test module: random-string/
OTP generation, key hashing, verification-value consume atomicity, cookie building,
session creation, plugin route shadowing/hooks, and the password_checks seam. Parity
with better-auth TS v1.6.23.

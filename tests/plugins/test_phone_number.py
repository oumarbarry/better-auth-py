...
Mirrors the behaviours in better-auth's phone-number/phone-number.test.ts. Wire/storage
fidelity is the point: exact verification-value formats ("<code>:<attempts>"), reset identifier
